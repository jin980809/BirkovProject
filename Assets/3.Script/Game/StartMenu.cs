...
//
// 세팅: 시작 씬의 StartUI(또는 아무 오브젝트)에 붙이고 버튼 4개와 Option 오브젝트를 연결한다.
// 버튼의 OnClick 은 비워둬도 된다 - 여기서 코드로 연결한다.
public class StartMenu : MonoBehaviour
{
    ...
    [Header("사운드 설정")]
    [Tooltip("사운드 버튼을 누르면 켜질 오브젝트 (OptionUI 가 붙은 Option). 시작할 때는 꺼 둔다")]
    ...
    private void OpenSoundPanel()
    {
        ...
        {
            Debug.LogWarning("StartMenu: Sound Panel 이 연결되지 않아 사운드 설정을 열 수 없습니다.", this);
        }
    }
